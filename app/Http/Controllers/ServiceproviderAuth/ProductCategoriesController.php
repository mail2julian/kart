...
class ProductCategoriesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('serviceprovider.products.product_categories.index', compact('product_categories'));
    }
    ...
    public function create()
    {
        ...
        return view('serviceprovider.product_categories.create');
    }
    ...
    public function store(StoreProductCategoriesRequest $request)
    {
        ...
        return redirect()->route('serviceprovider.product_categories.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('serviceprovider.product_categories.edit', compact('product_category'));
    }
    ...
    public function show($id)
    {
        ...
        return view('serviceprovider.product_categories.show', compact('product_category', 'products'));
    }
